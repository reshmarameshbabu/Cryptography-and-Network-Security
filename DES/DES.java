...
public class DES {
	...
	private void printBytesfinal(byte[] input) {	
	...
	public String byteToHex(byte num) {
		...
		//System.out.println(hexDigits,"Base64");
...
//		String c = new String(cipher, StandardCharsets.UTF_8);
